...
const Layout: Component<{ children?: any }> = (props) => {
  ...
  return (
    <div className="min-h-screen bg-gemini-background text-gemini-gray text-sm">
      <header className="fixed top-0 left-0 right-0 z-20 bg-gemini-msg-bg border-b border-gemini-dark-gray px-4 py-2 flex items-center gap-2">
        ...
        <Show
          ...
          fallback={
            <h1 className="text-base font-bold text-gemini-foreground">
              Gemini CLI
            </h1>
          }
        >
          ...
          <span className="font-mono text-xs text-gemini-comment">
      ...
      <main className="pt-12 pb-16">{props.children}</main>
    </div>
  );
};

const HomePage: Component = () => <Home />;
