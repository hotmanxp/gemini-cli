...
function buildSystemPrompt(skillsDir: string, memoryDir: string): string {
  return [
    ...
    '             file ~/.gemini/AGENTS.md. No other files in ~/.gemini/ are',
    ...
    '',
    'Project/workspace shared instructions (AGENTS.md and similar files under the',
    ...
    '',
    'NEVER directly edit MEMORY.md, AGENTS.md, ~/.gemini/AGENTS.md, settings,',
