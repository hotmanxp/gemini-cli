...
describe('useApprovalModeIndicator', () => {
  ...
  it('should cycle the indicator and update config when Shift+Tab or Ctrl+Y is pressed', async () => {
    ...
    // Shift+Tab cycles to YOLO (from AUTO_EDIT)
    act(() => {
      capturedUseKeypressHandler({
        name: 'tab',
        shift: true,
    ...
    // Shift+Tab from DEFAULT cycles to AUTO_EDIT
    act(() => {
      capturedUseKeypressHandler({
        name: 'tab',
        shift: true,
  ...
  describe('in untrusted folders', () => {
    ...
    it('should enable YOLO mode when Shift+Tab is pressed', async () => {
  ...
  it('should handle multiple mode changes correctly', async () => {
    ...
    // Switch to DEFAULT (toggle from YOLO)
    act(() => {
      capturedUseKeypressHandler({ name: 'y', ctrl: true } as Key);
    });
  ...
  it('should cycle to YOLO when allowPlanMode is false', async () => {
    mockConfigInstance.getApprovalMode.mockReturnValue(ApprovalMode.AUTO_EDIT);
