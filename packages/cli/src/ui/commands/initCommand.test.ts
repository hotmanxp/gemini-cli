...
describe('initCommand', () => {
  ...
  it('should inform the user if AGENTS.md already exists', async () => {
    ...
    expect(result).toEqual({
      ...
      messageType: 'info',
      content:
        'A AGENTS.md file already exists in this directory. No changes were made.',
    });
    // Assert: Ensure no file was written
    expect(fs.writeFileSync).not.toHaveBeenCalled();
  });

  it('should create AGENTS.md and submit a prompt if it does not exist', async () => {
