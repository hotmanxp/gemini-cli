...
import {
  ...
  loopStatusCommand,
  cancelLoopCommand,
} from '../ui/commands/loopCommand.js';
import { mcpCommand } from '../ui/commands/mcpCommand.js';
import { memoryCommand } from '../ui/commands/memoryCommand.js';
// import { modelCommand } from '../ui/commands/modelCommand.js';
import { customModelsCommand as modelCommand } from '../ui/commands/customModelsCommand.js';
  ...
  async loadCommands(_signal: AbortSignal): Promise<SlashCommand[]> {
    ...
    const allDefinitions: Array<SlashCommand | null> = [
      ...
      ...(this.config?.getEnableHooks()
        ? [loopCommand, ulwLoopCommand, loopStatusCommand, cancelLoopCommand]
        : []),
