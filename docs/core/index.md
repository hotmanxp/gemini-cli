...
- **[Memory Import Processor](../reference/memport.md):** Documentation for the
  modular AGENTS.md import feature using @file.md syntax.
...
- **Prompt engineering:** Constructing effective prompts for the Gemini model,
  ...
  instructional context from `AGENTS.md` files.
...
`AGENTS.md` files that provide context to the model. It searches for these files
...
and `refresh` the content of loaded `AGENTS.md` files.
