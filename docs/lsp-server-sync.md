...
**包管理器支持**: | 包管理器 | 数量 | 示例 | |----------|------|------| |
**npm** | 11 | typescript-language-server, vue-language-server | | **pip** | 2 |
pyright, pylsp | | **system** | 10 | clangd, jdtls, terraform-ls | | **rustup**
| 1 | rust-analyzer | | **go** | 1 | gopls | | **gem** | 1 | ruby-lsp | |
**dotnet** | 2 | csharp-ls, fsautocomplete | | **opam** | 1 | ocamllsp | |
**nix** | 1 | nixd | | **ghcup** | 1 | haskell-language-server | | **cargo** | 1
| taplo |
...
**同步完成！Gemini
CLI 现在支持 40 种编程语言，达到与 OpenCode 同等的语言覆盖水平。**
