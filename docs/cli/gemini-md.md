...
Here is an example of what you can include in a `AGENTS.md` file at the root of
...
- **`/memory add <text>`**: Appends your text to your global
  `~/.gemini/AGENTS.md` file. This lets you add persistent memories on the fly.
...
While `AGENTS.md` is the default filename, you can configure this in your
...
{
  "context": {
    "fileName": ["AGENTS.md", "CONTEXT.md", "AGENTS.md"]
  }
}
```
