...
| Hide Context Summary                 | `ui.hideContextSummary`                | Hide the context summary (AGENTS.md, MCP servers) above the input.                                                                                                | `false` |
...
| Load Memory From Include Directories | `context.loadMemoryFromIncludeDirectories`        | Controls how /memory reload loads AGENTS.md files. When true, include directories are scanned; when false, only the current directory is used.                                                                                              | `false` |
