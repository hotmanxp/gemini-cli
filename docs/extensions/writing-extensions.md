...
Provide persistent context to the model by adding a `AGENTS.md` file to your
...
Restart Gemini CLI. The model now has the context from your `AGENTS.md` file in
